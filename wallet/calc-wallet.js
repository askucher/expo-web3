...
(function(){
  ...
  getBalance = require('./api').getBalance;
  ref$ = require('./math'), times = ref$.times, plus = ref$.plus;
  ref$ = require('prelude-ls'), find = ref$.find, map = ref$.map, pairsToObj = ref$.pairsToObj, foldl = ref$.foldl, filter = ref$.filter;
  ref$ = require('./workflow'), run = ref$.run, task = ref$.task;
  round5 = require('./round5');
  roundHuman = require('./round-human');
