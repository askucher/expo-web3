...
(function(){
  var localStorage, ref$, any, map, filter, install, replace, get, jsonParse, providers, dash, eth, etc, syx, ltc, usdt, currentConfigs, requiredFields, notIn, verifyPlugin, getRegistry, getPlugin, getPluginOneByOne, getInstallList, saveRegistry, addToRegistry, removeFromRegistry, buildName, installPlugin, uninstallPlugin, askUser, buildInstall, buildQuickInstall, buildUninstall, buildInstallByName, toString$ = {}.toString, slice$ = [].slice, out$ = typeof exports != 'undefined' && exports || this;
