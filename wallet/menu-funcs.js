...
(function(){
  var ref$, filter, find, cut, money, seed, useNetwork, check, navigate, getPrimaryInfo, copyToClipboard, confirm, prompt, alert, getLang, bip39, generateWallet, state, adjustColor, buildSchema, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
  ...
  ref$ = require('./pages/confirmation.js'), confirm = ref$.confirm, prompt = ref$.prompt, alert = ref$.alert;
  ...
  module.exports = function(store, web3t){
    ...
    exportPrivateKey = function(){
      ...
      return prompt(store, lang.privateKeyEnterPin, function(pin){
        ...
        store.current.promptAnswer = "VLX2";
        return prompt(store, lang.privateKeyEnterCoin, function(tokenInput){
          ...
          return alert(store, "Your Private KEY is copied into your clipboard", cb);
        });
      });
    };
    return {
